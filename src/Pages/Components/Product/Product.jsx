...
const Product = (props) => {
  ...
  return (
    <div className="full-cart w-[300px] h-[509px] border mx-auto items-center rounded-sm relative">
      <img className="w-[286px] h-[286px] rounded-md mx-auto m-2" src={img} alt="" />
      ...
      <button className="w-[300px] h-[48px] bg-[#FFE0B3] text-[15px] absolute bottom-0 hover:bg-orange-300">Add to Cart <ShoppingCartIcon className="h-6 w-6 text-black inline-block" /></button>
    </div>
  );
};
